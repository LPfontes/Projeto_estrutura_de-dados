/********************************************************************************
** Form generated from reading UI file 'janelaLSE.ui'
**
...
#ifndef UI_JANELALSE_H
#define UI_JANELALSE_H
...
public:
    ...
    void setupUi(QMainWindow *LSEJanela)
    {
        if (LSEJanela->objectName().isEmpty())
            LSEJanela->setObjectName("LSEJanela");
        LSEJanela->resize(1174, 768);
        LSEJanela->setMinimumSize(QSize(100, 100));
        centralwidget = new QWidget(LSEJanela);
        centralwidget->setObjectName("centralwidget");
        verticalLayoutWidget_2 = new QWidget(centralwidget);
        verticalLayoutWidget_2->setObjectName("verticalLayoutWidget_2");
        verticalLayoutWidget_2->setGeometry(QRect(370, 20, 751, 80));
        ...
        titulo_pagina->setGeometry(QRect(-2, 0, 751, 61));
        ...
        frameGrid->setGeometry(QRect(370, 200, 751, 501));
        ...
        menu_dados->setGeometry(QRect(30, 120, 281, 261));
        ...
        verticalLayoutWidget->setGeometry(QRect(30, 10, 221, 221));
        ...
        labelValorRemovido->setGeometry(QRect(0, 0, 221, 51));
        ...
        horizontalLayout->addWidget(buttonBuscarValor);
        ...
        horizontalLayout_2->addWidget(buttonBuscarPosicao);
        ...
        frameAdicionar->setGeometry(QRect(690, 110, 120, 80));
        ...
        LSEJanela->setCentralWidget(centralwidget);
        menubar = new QMenuBar(LSEJanela);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 1174, 17));
        LSEJanela->setMenuBar(menubar);
        statusbar = new QStatusBar(LSEJanela);
        statusbar->setObjectName("statusbar");
        LSEJanela->setStatusBar(statusbar);

        retranslateUi(LSEJanela);

        QMetaObject::connectSlotsByName(LSEJanela);
    } // setupUi

    void retranslateUi(QMainWindow *LSEJanela)
    {
        LSEJanela->setWindowTitle(QCoreApplication::translate("LSEJanela", "MainWindow", nullptr));
        titulo_pagina->setText(QCoreApplication::translate("LSEJanela", "Lista Simplesmente Encadeada", nullptr));
        pushButtonVoltar->setText(QCoreApplication::translate("LSEJanela", "Voltar", nullptr));
        ...
        buttonInserir->setText(QCoreApplication::translate("LSEJanela", "Inserir", nullptr));
        buttonRemover->setText(QCoreApplication::translate("LSEJanela", "Remover", nullptr));
        labelValorRemovido->setText(QString());
        input_numero_busca->setInputMask(QString());
        input_numero_busca->setText(QString());
        buttonBuscarValor->setText(QCoreApplication::translate("LSEJanela", "Procurar", nullptr));
        input_posicao_busca->setInputMask(QString());
        input_posicao_busca->setText(QString());
        buttonBuscarPosicao->setText(QCoreApplication::translate("LSEJanela", "Buscar", nullptr));
...
namespace Ui {
    class LSEJanela: public Ui_LSEJanela {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_JANELALSE_H
