...
long ListaSeq::tamanho(){
	return nElementos;
}
long ListaSeq::tamanhoMax(){
    return Tamanho;
}
/** Obtém o i-ésimo elemento de uma lista.
    Retorna -1 se a posição for inválida. */
long ListaSeq::elemento(long pos){
...
long ListaSeq::posicao (long valor){
...
/**	Retorna a posição de um elemento pesquisado.
	Retorna -1 caso não seja encontrado */
long ListaSeq::posicao (long valor, long desloc){
		/* Procura elemento a elemento, se o dado está na
		lista. Se estiver, retorna a sua posição no array+1 */
...
bool ListaSeq::insere (long pos, long valor){
