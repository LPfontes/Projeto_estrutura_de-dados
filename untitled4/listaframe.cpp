...
bool ListaFrame::vazia() {
    return (nElementos == 0);
}


/**Obtém o tamanho da Lista*/
long ListaFrame::tamanho() {
    //return nElementos;
...
Frame* ListaFrame::elemento (long pos) {
    if (vazia())
...
bool ListaFrame::insereInicioLista(Frame* valor) {
...
bool ListaFrame::insereMeioLista(long pos, Frame* valor){
...
bool ListaFrame::insere(long pos, Frame* valor) {
    if ((vazia()) && (pos != 1))
...
bool ListaFrame::insere(Frame* valor) {
...
Frame* ListaFrame::removeInicioLista(){
...
Frame* ListaFrame::removeNaLista(long pos){
...
Frame* ListaFrame::remove(long pos) {
    if (vazia())
...
NoFrame* ListaFrame::getNo(long pos){
    NoFrame* aux = cabeca;
